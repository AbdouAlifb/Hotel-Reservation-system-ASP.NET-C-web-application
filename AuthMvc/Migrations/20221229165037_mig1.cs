        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantIdMeal = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Restaurants", x => x.IdMeal);
                    table.ForeignKey(
                        name: "FK_Restaurants_Restaurants_RestaurantIdMeal",
                        column: x => x.RestaurantIdMeal,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdChambre = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: false),
                    Description = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rooms", x => x.IdChambre);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdChambre = table.Column<int>(nullable: false),
                    Date_entrée = table.Column<DateTime>(nullable: false),
                    Date_sortie = table.Column<DateTime>(nullable: false),
                    NombrePlace = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_Rooms_IdChambre",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_RestaurantIdMeal",
                table: "Restaurants",
                column: "RestaurantIdMeal");
        }
